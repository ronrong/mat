 ...
 * @author:rongshaolin
 */
public class HeaderClassLoaderTemplateResource implements IDecorationResource {
    private ClassLoaderTemplateResource classLoaderTemplateResource;


    public HeaderClassLoaderTemplateResource(final String path, final ClassLoader classLoader) {
