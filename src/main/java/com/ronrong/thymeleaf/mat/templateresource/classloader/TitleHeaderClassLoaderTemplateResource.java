 ...
 * @author:rongshaolin
 */
public class TitleHeaderClassLoaderTemplateResource implements IDecorationResource {
    private ClassLoaderTemplateResource classLoaderTemplateResource;



    public TitleHeaderClassLoaderTemplateResource(final String path, final ClassLoader classLoader) {
