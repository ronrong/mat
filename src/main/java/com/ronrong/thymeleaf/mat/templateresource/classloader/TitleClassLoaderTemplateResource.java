 ...
 * @author:rongshaolin
 */
public class TitleClassLoaderTemplateResource implements IDecorationResource {
    private ClassLoaderTemplateResource classLoaderTemplateResource;



    public TitleClassLoaderTemplateResource(final String path, final ClassLoader classLoader) {
