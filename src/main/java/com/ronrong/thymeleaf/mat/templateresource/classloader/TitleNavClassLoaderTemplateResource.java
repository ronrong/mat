 ...
 * @author:rongshaolin
 */
public class TitleNavClassLoaderTemplateResource implements IDecorationResource {
    private ClassLoaderTemplateResource classLoaderTemplateResource;



    public TitleNavClassLoaderTemplateResource(final String path, final ClassLoader classLoader) {
    ...
    public Object content() throws IOException {
        ...
        while (iterator.hasNext()) {
            titleName = (String) iterator.next();
        }
