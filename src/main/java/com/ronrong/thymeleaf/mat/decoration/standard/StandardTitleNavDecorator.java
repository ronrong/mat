...
/**
 * @Description:title 导航装修工
 * @author:rongshaolin
 */
public class StandardTitleNavDecorator extends AbstractDecorator {


    private static final Logger logger = LoggerFactory.getLogger(StandardSlideDecorator.class);

    public StandardTitleNavDecorator(IDecorationConfiguration decorationConfiguration, Shop shop, DecorationStyle decorationStyle) {
