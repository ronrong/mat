 ...
 * @author:rongshaolin
 */
public class TitleNavElementProcessor extends AbstractMatProcessor {

    private static final String ELEMENT_NAME = "titleNav";//标签名
    ...
    public TitleNavElementProcessor(String dialectPrefix) {
        super(
    ...
    public CommonEnum.DecoratorTypeEnum getDecoratorType() {
        return CommonEnum.DecoratorTypeEnum.TITLENAV;
    }
