 ...
 * @author:rongshaolin
 */
public class ProductElementProcessor extends AbstractMatProcessor {

    private static final String ELEMENT_NAME = "product";//标签名
    ...
    public ProductElementProcessor(String dialectPrefix) {
        super(
    ...
    public CommonEnum.DecoratorTypeEnum getDecoratorType() {
        return CommonEnum.DecoratorTypeEnum.PRODUCT;
    }
