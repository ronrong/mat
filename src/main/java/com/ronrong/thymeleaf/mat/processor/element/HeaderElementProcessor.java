 ...
 * @author:rongshaolin
 */
public class HeaderElementProcessor extends AbstractMatProcessor {

    private static final String ELEMENT_NAME = "header";//标签名
    ...
    public HeaderElementProcessor(String dialectPrefix) {
        super(
    ...
    public CommonEnum.DecoratorTypeEnum getDecoratorType() {
        return CommonEnum.DecoratorTypeEnum.HEADER;
    }
