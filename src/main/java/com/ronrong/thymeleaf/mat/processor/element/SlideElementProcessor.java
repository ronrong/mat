 ...
 * @author:rongshaolin
 */
public class SlideElementProcessor extends AbstractMatProcessor {

    private static final String ELEMENT_NAME = "slide";//标签名
    ...
    public SlideElementProcessor(String dialectPrefix) {
        super(
    ...
    public CommonEnum.DecoratorTypeEnum getDecoratorType() {
        return CommonEnum.DecoratorTypeEnum.SLIDE;
    }
