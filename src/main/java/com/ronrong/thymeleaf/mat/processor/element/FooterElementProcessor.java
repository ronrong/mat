 ...
 * @author:rongshaolin
 */
public class FooterElementProcessor extends AbstractMatProcessor {

    private static final String ELEMENT_NAME = "footer";//标签名
    ...
    public FooterElementProcessor(String dialectPrefix) {
        super(
    ...
    public CommonEnum.DecoratorTypeEnum getDecoratorType() {
        return CommonEnum.DecoratorTypeEnum.FOOTER;
    }
