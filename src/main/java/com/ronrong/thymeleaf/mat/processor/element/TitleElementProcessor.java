...
public class TitleElementProcessor extends AbstractMatProcessor {

    private static final String ELEMENT_NAME = "title";//标签名
    private static final int PRECEDENCE = 300;//优先级
    private static final Logger logger = LoggerFactory.getLogger(TitleElementProcessor.class);

    public TitleElementProcessor(String dialectPrefix) {
        super(
    ...
    public CommonEnum.DecoratorTypeEnum getDecoratorType() {
        return CommonEnum.DecoratorTypeEnum.TITLE;
    }
