 ...
 * @author:rongshaolin
 */
public class BottomNavBarElementProcessor extends AbstractMatProcessor {

    private static final String ELEMENT_NAME = "bottomNavBar";//标签名
    ...
    public BottomNavBarElementProcessor(String dialectPrefix) {
        super(
    ...
    public CommonEnum.DecoratorTypeEnum getDecoratorType() {
        return CommonEnum.DecoratorTypeEnum.BOTTOMNAVBAR;
    }
